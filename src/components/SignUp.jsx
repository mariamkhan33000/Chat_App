            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    ...
                    <div className="py-4">
                        <input 
                         ...
                         {...register("fullname", { required: true })} 
                          className="bg-transparent border w-full px-2 py-4 rounded-xl " placeholder="fullname . . . " />
                    ...
                    <div className="py-4">
                        <input 
                         ...
                         {...register("confirmPassword", { required: true, validate: validatePasswordMatch })} 
                          className="bg-transparent border w-full px-2 py-4 rounded-xl " placeholder="confirmPassword . . . . . " />
                    ...
                    <div className=" flex mt-4 items-center space-x-3 justify-around">
                        ...
                        <h2 className="text-blue-400 underline cursor-pointer hover:scale-125">Login</h2>
                        <button className="btn btn-accent text-white bg-green-500 text-xl cursor-pointer hover:bg-green-800">Signup</button>
                    </div>
                </div>
                </div>
            </form>
